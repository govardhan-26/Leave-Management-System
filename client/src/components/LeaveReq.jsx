                  ...
                  {LeaveRequests.map((leave, leaveid)=>(
                        <tr className={leaveid % 2 === 0 ? 'bg-white' : 'bg-gray-100'} key={leaveid}>
                          ...
                          <td class="border border-gray-300 px-4 py-2 flex justify-evenly">
                            <button className='border border-black rounded p-2 bg-green-300'>Accept</button>
                            <button className='border border-black rounded p-2 bg-blue-200'>Forward</button>
                            <button className='border border-black rounded p-2 bg-red-500'>Reject</button>
                          </td>
                        </tr>
                      )
                    )}
